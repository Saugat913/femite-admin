...
import type { Category, CloudinaryUploadResponse } from '@/types'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const productData = {
        ...
        price: parseFloat(form.price.toFixed(2)), // Send as decimal dollars
        stock: form.stock,
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    JPG, PNG or WebP. Max size 5MB. Uploaded to Cloudinary.
                  </p>
                </div>
              </div>
            </div>
